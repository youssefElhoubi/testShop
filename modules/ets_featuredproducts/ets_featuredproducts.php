...
class Ets_FeaturedProducts extends Module implements WidgetInterface
{
    private $templateFile;
    protected static $cache_feature_products;

    public function __construct()
    {
        $this->name = 'ets_featuredproducts';
        ...
        $this->templateFile = 'module:ets_featuredproducts/views/templates/hook/ets_featuredproducts.tpl';
    }
    ...
    public function hookdisplayHomeTab($params)
    {
        ...
        if (!$this->isCached('tab.tpl', $this->getCacheId('Ets_FeaturedProducts-tab')))
            Ets_FeaturedProducts::$cache_feature_products = $this->getProducts();

        if (Ets_FeaturedProducts::$cache_feature_products === false)
            return false;
        return $this->display(__FILE__, 'tab.tpl', $this->getCacheId('Ets_FeaturedProducts-tab'));
    }
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        return $this->display(__FILE__, 'tab_content.tpl', $this->getCacheId('Ets_FeaturedProducts-home'));
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('ets_featuredproducts'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('ets_featuredproducts'));
    }
