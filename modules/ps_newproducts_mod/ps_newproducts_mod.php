...
class Ps_newproducts_mod extends Module implements WidgetInterface
{
    ...
    /* custom module add tab*/
    
    public function hookdisplayHomeTab($params)
    {
        if (!$this->isCached('tab.tpl', $this->getCacheId('Ps_NewProducts-tab')))
            Ps_NewProducts_mod::$cache_new_products = $this->getNewProducts();

        if (Ps_NewProducts_mod::$cache_new_products === false)
                return false;
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        return $this->display(__FILE__, 'ps_newproducts_home.tpl', $this->getCacheId('Ps_NewProducts-home'));
    }
