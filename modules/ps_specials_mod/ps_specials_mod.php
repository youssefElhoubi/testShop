...
class Ps_specials_mod extends Module implements WidgetInterface
{
    ...
    public function hookdisplayHomeTab($params)
    {
        ...
        if (!$this->isCached('tab.tpl', $this->getCacheId('Ps_specials-tab')))
            Ps_Specials_mod::$cache_specials_products = $this->getSpecialProducts();

        if (Ps_Specials_mod::$cache_specials_products === false)
                return false;
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        return $this->display(__FILE__, 'ps_specials_home.tpl', $this->getCacheId('Ps_specials-home'));
    }
