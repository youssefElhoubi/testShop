...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->configs = array(
            ...
            'YBC_TC_SUBTITLE_SECTION_TABHOME' => array(
                'label' => $this->l("Enter sub title section tab product"),
                'type' => 'text',
                'default' => 'Discover our amazing cosmetic products',
                'lang' => true,
                'group' => 'ybc_tab_home',
            ),
...
ibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet',
            ...
            'YBC_TC_COPYRIGHT_TEXT' => array(
                ...
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',
                'default' => 'Copyright 2017 <a href="#">The Cosmetics Co., LTD.</a>  All rights reserved<br />Website is proudly powered by <a class="_blank" href="http://www.prestashop.com">Prestashop</a>',
            ),
            ...
            'YBC_TC_FONT1_DATA' => array(
                ...
                'separator' => true,
                'data_type' => 'font',
                'default' => 'https://fonts.googleapis.com/css?family=Roboto:300,400,500,700',
                'validate' => 'isString',
            ),
