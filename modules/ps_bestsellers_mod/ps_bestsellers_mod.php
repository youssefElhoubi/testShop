...
class Ps_BestSellers_Mod extends Module implements WidgetInterface
{
    ...
    public function hookdisplayHomeTab($params){
        if (!$this->isCached('tab.tpl', $this->getCacheId('Ps_BestSellers-tab')))
                Ps_BestSellers_Mod::$cache_new_products = $this->getBestSellers();

        if (Ps_BestSellers_Mod::$cache_new_products === false)
                return false;
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        return $this->display(__FILE__, 'ps_bestsellers_home.tpl', $this->getCacheId('Ps_BestSellers-home'));
    }
